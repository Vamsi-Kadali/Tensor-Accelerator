...
#
# Script generated by Vivado on Mon Mar 30 19:07:24 +0530 2026
...
#
# Usage        : bram_A.sh
#                bram_A.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_A.sh [-reset_run]
#                bram_A.sh [-reset_log]
#                bram_A.sh [-help]
#
...
# script info
echo -e "bram_A.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_A.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram_A xil_defaultlib.bram_A xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_A -key {Behavioral:sim_1:Functional:bram_A} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_A.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_A.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_A.sh [-help]\n\
Usage: bram_A.sh [-step]\n\
Usage: bram_A.sh [-lib_map_path]\n\
Usage: bram_A.sh [-reset_run]\n\
Usage: bram_A.sh [-reset_log]\n\
Usage: bram_A.sh [-keep_index]\n\
Usage: bram_A.sh [-noclean_files]\n\n\
