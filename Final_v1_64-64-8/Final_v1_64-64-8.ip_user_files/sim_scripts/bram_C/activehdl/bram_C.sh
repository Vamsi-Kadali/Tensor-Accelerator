...
#                script (type 'bram_C.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/kpcha/Desktop/College/DSD/Bitstream_Large_Tensors_v2/Bitstream_Large_Tensors_v2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
