...
REM
REM Generated by Vivado on Tue Mar 24 14:39:07 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_tensor_top_fpga_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_tensor_top_fpga_vlog.prj -log xvlog.log
