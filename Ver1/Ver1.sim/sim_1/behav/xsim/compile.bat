...
REM
REM Generated by Vivado on Sun Mar 01 22:37:20 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_simple_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_simple_vlog.prj -log xvlog.log
