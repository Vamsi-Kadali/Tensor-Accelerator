...
REM
REM Generated by Vivado on Sat Mar 14 20:58:07 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_matrix_cont_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_matrix_cont_vlog.prj -log xvlog.log
