...
REM
REM Generated by Vivado on Sun Mar 15 12:25:28 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_matrix_cont_random_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_matrix_cont_random_vlog.prj -log xvlog.log
