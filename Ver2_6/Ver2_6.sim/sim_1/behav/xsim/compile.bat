...
REM
REM Generated by Vivado on Tue Mar 24 01:31:11 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fpga_top_uart_random_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fpga_top_uart_random_vlog.prj -log xvlog.log
