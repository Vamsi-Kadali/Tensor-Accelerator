...
REM
REM Generated by Vivado on Tue Mar 17 11:09:01 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_tensor_top_random_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_tensor_top_random_vlog.prj -log xvlog.log
