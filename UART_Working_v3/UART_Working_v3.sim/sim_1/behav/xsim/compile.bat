...
REM
REM Generated by Vivado on Sat Mar 28 13:47:28 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_uart_tensor_bridge_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_uart_tensor_bridge_vlog.prj -log xvlog.log
